...
import pro1 from  '../imags/product/related/rp-3.jpg';
import rp from '../imags/product/related/rp-1.jpg';
            ...
            <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg={rp}>
                            <div class="label new">New</div>
                            <ul class="product__hover">
                                <li><a href="j" class="image-popup"><span class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg={pro1}>
